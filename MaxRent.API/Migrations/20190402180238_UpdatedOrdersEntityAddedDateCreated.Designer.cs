...
namespace MaxRent.API.Migrations
{
    ...
    [Migration("20190402180238_UpdatedOrdersEntityAddedDateCreated")]
    partial class UpdatedOrdersEntityAddedDateCreated
    {
            ...
            modelBuilder.Entity("MaxRent.API.Models.Order", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new DateTime(2019, 4, 2, 21, 2, 37, 917, DateTimeKind.Local).AddTicks(8805));
